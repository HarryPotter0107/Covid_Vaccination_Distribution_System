...
import com.covidvaccination.distributionsystem.Covid.Vaccination.Distribution.Backend.dto.response.GeneralMessageDTO;
...
public class PatientController {
    ...
    public ResponseEntity createAppointment(@RequestParam String email, @RequestParam VaccinationCenterPrefrence vaccinationCenterPrefrence){
        com.covivaccination.distributionsystem.Covid.Vaccination.Distribution.Backend.dto.response.AppointmentDTO appointmentDTO = patientService.createAppointment(email, vaccinationCenterPrefrence.toString());
